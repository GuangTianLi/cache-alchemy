...
cache_alchemy could always use more documentation, whether as part of the
official cache_alchemy docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.6+. Check
   https://travis-ci.org/GuangTianLi/cache_alchemy/pull_requests
